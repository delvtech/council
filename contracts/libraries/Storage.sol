...
library Storage {
    ...
    function addressPtr(string memory name) internal pure returns(Address storage data) {
    ...
    /// @param name the variable name
    /// @return data the storage pointer
    function uint256Ptr(string memory name) internal pure returns(Uint256 storage data) {
    ...
    function mappingAddressToUnit256Ptr(string memory name) internal pure returns(mapping(address => uint256) storage data) {
